...
Read `the project instructions` before touching anything in this tree. It covers
the environment, the workstation bridge, and where things get filed. This file
exists to point at it.

`the project instructions` on disk is the authoritative copy. A copy held as
